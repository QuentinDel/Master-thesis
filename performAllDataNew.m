...
%EPR:
% PATHS{end+1} = 'DATA_2018_05_25_PER_0_01/ONOFF';
% PATHS{end+1} = 'DATA_2018_06_15_PER_0_01_p_jam_0_1/ONOFF';
% PATHS{end+1} = 'DATA_2018_06_15_PER_0_01_p_jam_0_1/random';
% PATHS{end+1} = 'DATA_2018_06_15_PER_0_05_p_jam_0_1/ONOFF';
% PATHS{end+1} = 'DATA_2018_06_15_PER_0_05_p_jam_0_1/random';
% PATHS{end+1} = 'DATA_2018_05_25_PER_0_01/ONOFF';
% PATHS{end+1} = 'DATA_2018_05_25_PER_0_01/random';
% PATHS{end+1} = 'DATA_2018_05_25_PER_0_05/ONOFF';
% PATHS{end+1} = 'DATA_2018_05_25_PER_0_05/random';
% PATHS{end+1} = 'DATA_2018_06_20_PER_0_p_jam_0_4/ONOFF';
% PATHS{end+1} = 'DATA_2018_06_20_PER_0_p_jam_0_4/random';
...
for z = 1 : length(PATHS)
    ...
    path = PATHS{z};
    fullPath = strcat(prePath, path, '/');
    datasetNames = dir(strcat(fullPath, '*.mat'));
